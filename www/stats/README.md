...
Register a datasource plugin. See http://freeboard.github.io/stats/docs/plugin_example.html for information on creating plugins.

> **plugin** (object) - A plugin definition object as defined at http://freeboard.github.io/stats/docs/plugin_example.html

-------

**freeboard.loadWidgetPlugin(plugin)**

Register a widget plugin. See http://freeboard.github.io/stats/docs/plugin_example.html for information on creating plugins.
...
See http://freeboard.github.io/stats/docs/plugin_example.html for info on how to build plugins for freeboard.
