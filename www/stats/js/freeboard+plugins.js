...
DeveloperConsole = function(theFreeboardModel)
{
	function showDeveloperConsole()
	{
		...
		container.append($("<p>Here you can add references to other scripts to load datasource or widget plugins.</p>"))
			.append(table)
			.append(addScript)
            .append('<p>To learn how to build plugins for freeboard, please visit <a target="_blank" href="http://freeboard.github.io/stats/docs/plugin_example.html">http://freeboard.github.io/stats/docs/plugin_example.html</a></p>');
